...
# here we need to update list of parameters and their corresponding input files names
...
dir.create("VSACalib")
file.copy(list.files("~/Dan_VSA_Calib/TxtInOutLOC/",full.names = TRUE,recursive = TRUE),"/dev/shm/rojakaveh/VSACalib/",recursive = TRUE)
setwd("VSACalib/")
